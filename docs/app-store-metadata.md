...
## 작성일: 2026-03-07
## 상태: 초안 완성 (제출 전 기술 아키텍처 해결 선행 필요)
...
| 필드 | URL |
|---|---|
| Support URL | https://snapmaster.app/support |
| Privacy Policy URL | https://snapmaster.app/privacy |
| Marketing URL | https://snapmaster.app |

주의: 제출 전 실제 접근 가능한 페이지 필수. 404 시 거절.
Privacy Policy 필수 항목: 수집 데이터, 사용 목적, 제3자 공유, 연락처, 업데이트 날짜.
...
- [ ] CGEventTap / Carbon HIToolbox 아키텍처 샌드박스 호환 재작성 완료 여부
- [ ] Bundle ID 확정: com.yourcompany.snapmaster
- [ ] SKU 확정: SNAPMASTER-001
- [ ] Support URL 및 Privacy Policy URL 실제 접근 가능 여부
- [ ] 스크린샷 1280x800 또는 1440x900 최소 1장
